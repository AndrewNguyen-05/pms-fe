...
const StudentProfile = () => {
  ...
  console.log(">>> check user data:", userData, ", project data:", projectData);
  return (
    <>
        ...
        <div className="bg-white shadow-md rounded-md my-5 mr-5 w-full p-2">
          ...
          <div className="text-left mx-10">
            <div className="text-lg w-full leading-relaxed text-gray-500 flex flex-col gap-3 mt-3">
              ...
              <div className="flex justify-between gap-5">
                <fieldset className="border border-solid w-1/2 border-gray-300 py-2 px-3 rounded-lg">
                  ...
                  <div className="mb-1">
                    <span className="font-bold text-gray-700">Student 1:</span>{" "}
                    {projectData.Implementation?.Student1?.User.name} -{" "}
                    {projectData.Implementation?.Student1?.studentCode}
                  </div>
                  <div className="my-1">
                    <span className="font-bold text-gray-700">Student 2:</span>{" "}
            ...
            <div className="flex justify-end w-full gap-3 mb-1">
              <CancelModal
                hrefConfirm="/student/profile/view-profile"
