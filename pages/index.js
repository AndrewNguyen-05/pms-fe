        ...
        <div className="bg-slate-50 w-full h-full flex flex-col items-center">
            ...
            <div>
              <ol className="main-page-card-list list-decimal font-semibold ">
                <li className="hover:text-gray-500 cursor-pointer">
                  <Link href="#project">Quản lý danh sách đồ án</Link>
                </li>
                <li className="hover:text-gray-500 cursor-pointer">
                  <Link href="#announcement">Quản lý danh sách thông báo</Link>
                </li>
                <li className="hover:text-gray-500 cursor-pointer">
                  <Link href="#score">Quản lý điểm số sinh viên</Link>
                </li>
                <li className="hover:text-gray-500 cursor-pointer">
                  <Link href="#analysis">Quản lý báo cáo, thống kê </Link>
                </li>
              </ol>
            </div>
          </div>
          <div className="main-page-card">
            ...
            <div>
              <ul className="main-page-card-list list-disc">
                <li>
                  Xem và quản lý những đồ án có trong hệ thống, bằng cách vào
                  tab <b>Project</b> trên thanh navigation
                </li>
                <li>
          ...
          <div className="main-page-card">
            ...
            <div>
              <ul className="main-page-card-list list-disc">
                <li>
                  Xem và quản lý những thông báo có trong hệ thống, bằng cách
                  vào tab <b>Announcement</b> trên thanh navigation
                </li>
                <li>
                  Xem chi tiết thông báo bằng cách nhấn vào thẻ thông báo cần
                  xem, nội dung sẽ được hiển thị chi tiết ở panel bên tay phải
                </li>
                <li>
          ...
          <div className="main-page-card">
            ...
            <div>
              <ul className="main-page-card-list list-disc">
                ...
                <li>
                  Trong tab <b>Analysis</b> sử dụng phím chuyển để chuyển đổi
                  qua lại giữa các biểu đồ thống kê
                </li>
                <li>
