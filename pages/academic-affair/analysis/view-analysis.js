...
import ExportExcel from "@/utils/exportAnalysis";
        ...
        <div className="flex justify-between items-center">
          ...
          >
            <ul className="font-medium flex gap-5 p-3 w-full border bg-white rounded-lg border-gray-100 rtl:space-x-reverse">
              <li>
                <div
                  className={activeIndex === 0 ? "nav-active" : "nav-default"}
                >
              ...
              <li>
                <div
                  className={activeIndex === 1 ? "nav-active" : "nav-default"}
                >
                  Register status
                </div>
              </li>
          ...
          <div className="p-0 mt-4">
            <div className="w-full items-center rounded-lg shadow-lg bg-white flex justify-between">
              <button
                ...
                onClick={handlePrev}
              >
                <span className="inline-flex items-center justify-center w-10 h-10 rounded-full bg-slate-400  group-hover:bg-slate-300 group-focus:ring-4 group-focus:ring-slate-200  group-focus:outline-none">
                  <svg
              ...
              <div className="">
                <div
                  className={
                    activeIndex === 0 ? "overflow-auto px-1" : "hidden"
                  }
                >
                ...
                <div
                  className={
                    activeIndex === 1 ? "overflow-auto px-1" : "hidden"
                  }
                >
                  <div className="font-semibold text-2xl ml-10 my-5">
                    Register status
              ...
              <button
                ...
                onClick={handleNext}
              >
                <span className="flex items-center justify-center w-10 h-10 rounded-full bg-slate-400 group-hover:bg-slate-300  group-focus:ring-4 group-focus:ring-slate-200  group-focus:outline-none">
                  <svg
                    className="w-4 h-4 text-white rtl:rotate-180"
                    aria-hidden="true"
                    xmlns="http://www.w3.org/2000/svg"
